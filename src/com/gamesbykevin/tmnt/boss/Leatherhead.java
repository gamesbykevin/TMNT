...
public class Leatherhead extends Boss implements PlayerRules
{
    ...
    public void setupAnimations()
    {
        ...
        animation.add(getSpriteRectangle(1,2), getNanoSeconds(250));
        ...
        animation.add(getSpriteRectangle(1,1), getNanoSeconds(100));
