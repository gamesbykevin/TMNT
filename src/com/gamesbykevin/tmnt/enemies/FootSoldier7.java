...
public final class FootSoldier7 extends Enemy implements PlayerRules
{
    ...
    public void setupAnimations()
    {
        ...
        animation = new SpriteSheetAnimation();
        animation.add(getSpriteRectangle(2,2), getNanoSeconds(700));
        animation.add(getSpriteRectangle(3,2), getNanoSeconds(200));
        ...
        getSpriteSheet().add(animation, State.PROJECTILE1_FINISH);
