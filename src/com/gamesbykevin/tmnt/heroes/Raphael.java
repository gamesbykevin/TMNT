...
public final class Raphael extends Hero implements PlayerRules
{
    private static final int SPRITE_WIDTH  = 85;
    private static final int SPRITE_HEIGHT = 77;
    ...
    public void setupAnimations()
    {
        ...
        animation.add(getSpriteRectangle(8,1), getNanoSeconds(200));
        ...
        animation.add(getSpriteRectangle(4,2), getNanoSeconds(200));
        getSpriteSheet().add(animation, State.ATTACK3);
        
        //attack4 animation
        animation = new SpriteSheetAnimation();
        animation.add(getSpriteRectangle(5,2), getNanoSeconds(30));
        animation.add(getSpriteRectangle(6,2), getNanoSeconds(30));
        animation.add(getSpriteRectangle(7,2), getNanoSeconds(30));
        animation.add(getSpriteRectangle(8,2), getNanoSeconds(30));
        ...
        animation.add(getSpriteRectangle(2,3), getNanoSeconds(200));
        ...
        animation.add(getSpriteRectangle(6,5), getNanoSeconds(200));
        getSpriteSheet().add(animation, State.ATTACK5);
        
        //jump animation
        animation = new SpriteSheetAnimation();
        animation.add(getSpriteRectangle(3,3), getNanoSeconds(50));
        ...
        animation.add(getSpriteRectangle(3,4), getNanoSeconds(75));
        getSpriteSheet().add(animation, State.JUMP);
        
        //jump kick animation
        animation = new SpriteSheetAnimation();
        animation.add(getSpriteRectangle(7,4), getNanoSeconds(25));
        animation.add(getSpriteRectangle(8,4), getNanoSeconds(75));
        animation.add(getSpriteRectangle(9,4), getNanoSeconds(75));
        ...
        //dead animation
        animation = new SpriteSheetAnimation();
        animation.add(getSpriteRectangle(3,9), getNanoSeconds(50));
        animation.add(getSpriteRectangle(4,9), getNanoSeconds(50));
        animation.add(getSpriteRectangle(5,9), getNanoSeconds(50));
        animation.add(getSpriteRectangle(6,9), getNanoSeconds(50));
        animation.add(getSpriteRectangle(7,9), getNanoSeconds(50));
        animation.add(getSpriteRectangle(8,9), getNanoSeconds(50));
